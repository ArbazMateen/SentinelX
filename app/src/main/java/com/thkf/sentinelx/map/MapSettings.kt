...
val ME : BitmapDescriptor = BitmapDescriptorFactory.fromResource(R.drawable.navigation) ?:
            BitmapDescriptorFactory.defaultMarker(DEFAULT_ME)

val ONLINE_MARKER : BitmapDescriptor = BitmapDescriptorFactory.fromResource(R.drawable.navigation_online) ?:
            BitmapDescriptorFactory.defaultMarker(DEFAULT_ONLINE_MARKER)

val OFFLINE_MARKER : BitmapDescriptor = BitmapDescriptorFactory.fromResource(R.drawable.navigation_offline) ?:
